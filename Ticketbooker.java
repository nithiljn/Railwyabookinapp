...
public class Ticketbooker
{
    ...
    static Map<Integer, Passanger> passengers = new HashMap<>();//map of passenger ids to passengers
    ...
    public void cancelTicket(int passengerId)
    {
        ...
        Passanger p = passengers.get(passengerId);
        ...
        if(racList.size() > 0)
        {
            ...
            Passanger passengerFromRAC = passengers.get(racList.poll());
            ...
            if(waitingList.size()>0)
            {
                ...
                Passanger passengerFromWaitingList = passengers.get(waitingList.poll());
